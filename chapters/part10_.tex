...
\chapter[Общее решение для ФГМ цилиндра]{Общее решение для механических и тепловых напряжений в полом функционально-градиентном цилиндре под действием неосесимметричных нагрузок в стационарном состоянии}\label{ch:ch2}
