...
\chapter[Постановка задачи термоупругости для функционально-градиентного материала (ФГМ)
]{Общее решение для механических и тепловых напряжений в полом функционально-градиентном цилиндре под действием неосесимметричных нагрузок в стационарном состоянии}\label{ch:ch2}
