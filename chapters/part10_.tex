\chapter{Теплопроводность. Простая постановка задачи}\label{ch:ch10}
...
\chapter[Постановка задачи термоупругости для функционально-градиентного материала (ФГМ)]{Общее решение для механических и тепловых напряжений в полом функционально-градиентном цилиндре под действием неосесимметричных нагрузок в стационарном состоянии}\label{ch:ch2}

\section{Введение} \label{ch:ch2/sec1}
...
\subsection{Постановка задачи теплопроводности}
...
Предпологается что неоднородный коэффициент теплопроводности выражается степенной функцией зависящей от \(r\), т.е. \(k(r)\) в виде
...
Уравнения \cref{eq:ch2:equation36} и \cref{eq:ch2:equation37} образуют систему линейных алгебраических уравнений (СЛАУ), где решение можно найти методом Крамера, например:
...
Подставляя \cref{eq:ch2:equation45} в  \cref{eq:ch2:equation1} и  \cref{eq:ch2:equation2}, получим соотношения для напряжений и деформаций:
