...
\begin{split}
	&\big [\eta \big (\eta -1 \big )+ \big (m_1 +1 \big ) \eta + \frac{\nu m_1}{1-\nu} -1 - \frac{\big (1 - 2\nu \big ) n^2}{2-2\nu} \big ] \big [ \eta \big (\eta -1 \big ) \\
	&+ \big ( m_1 + 1 \big ) \eta - m_1 - 1 - \frac{\big ( 2-2\nu \big ) n^2}{1-2\nu} \big ] +n^2 \big [ \frac{\eta}{2-2\nu} \\
	&+  \frac{ \big ( 4+2m_1 \big )\nu -3}{2-2\nu} \big ] \big [ \frac{\eta}{1-2\nu} + \frac{3-4\nu}{1-2\nu} +m_1 \big ] = 0
\end{split}
\end{equation}

Уравнение {eq:ch2:equation13} имеет четыре (4) корня --- от \( \eta_{n1} \) до \( \eta_{n4} \). Таким образом, общее решение уравнений {eq:ch2:equation9} и {eq:ch2:equation10} принимает вид:
...
\label{eq:ch2:equation15}
	N_{n_j} = \frac{i \big [ \eta_j \big (\eta_j -1 \big ) + \big ( m_1 +1 \big ) n_j +\frac{\nu m_1}{1-\nu} -1 - \frac{\big (1-2\nu \big ) n^2}{2-2\nu} \big ]}{n \big [ \frac{n_j}{2-2\nu} + \frac{\big (4+2m_1 \big )\nu -3}{2-2\nu} \big ]}
\end{equation}
